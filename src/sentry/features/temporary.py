...
def register_temporary_features(manager: FeatureManager) -> None:
    ...
    # Experiment: Sendo branch-fix-verify modal — offers 1:1 engineer support on the logs page
    manager.add("organizations:sendo-branch-fix-verify", OrganizationFeature, FeatureHandlerStrategy.FLAGPOLE, api_expose=True)
