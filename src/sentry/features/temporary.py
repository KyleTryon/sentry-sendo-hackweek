...
def register_temporary_features(manager: FeatureManager) -> None:
    ...
    # Experiment: Sendo peter-test embedded alert A/B test
    manager.add("organizations:sendo-peter-test", OrganizationFeature, FeatureHandlerStrategy.FLAGPOLE, api_expose=True)
